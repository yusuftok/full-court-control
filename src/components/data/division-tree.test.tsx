...
const createTestNode = (
  id: string,
  name: string,
  type: DivisionNode['type'] = 'division',
...
const sampleData: DivisionNode[] = [
  {
    ...
    children: [
      createTestNode('sub-1', 'Subdivision 1', 'subdiv'),
      {
        ...
        isExpanded: true,
        children: [createTestNode('task-1', 'Task 1', 'task')],
      },
    ],
  },
...
describe('DivisionTree Component', () => {
  ...
  describe('Node Type Indicators', () => {
    ...
    it('applies correct styling for node type indicators', () => {
      const { container } = render(
        <DivisionTree data={sampleData} onChange={mockOnChange} />
      )
  ...
  describe('Error Handling', () => {
    ...
    it('handles nodes without children array', () => {
      ...
      expect(() =>
        render(<DivisionTree data={malformedData} onChange={mockOnChange} />)
      ).not.toThrow()
    })
    ...
    it('handles missing isExpanded property', () => {
      ...
      expect(() =>
        render(
          <DivisionTree data={dataWithoutExpanded} onChange={mockOnChange} />
        )
      ).not.toThrow()
    })
  })
  ...
  describe('Performance', () => {
    it('handles large tree structures', () => {
      ...
      expect(() =>
        render(<DivisionTree data={largeData} onChange={mockOnChange} />)
      ).not.toThrow()
    })
