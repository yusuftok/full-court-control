import { NodeType, NodeFlags, DivisionNode } from '@/components/templates/template-types'
...
export const computeNodeFlags = (
  ...
  return {
    ...
    canDrop: isTemplateMode || nodeType === NodeType.INSTANCE || nodeType === NodeType.GHOST
  }
}
...
export const createInstanceNode = (data: {
  ...
  return {
    ...
    nodeType: NodeType.INSTANCE,
    ...data,
    _flags: computeNodeFlags({ nodeType: NodeType.INSTANCE } as DivisionNode, 'division')
  }
}
...
export const createGhostNode = (
  ...
  return {
    ...
    instanceCount,
    _flags: computeNodeFlags({ nodeType: NodeType.GHOST } as DivisionNode, 'division')
  }
}

// Ensure node has proper flags computed
export const ensureNodeFlags = (node: DivisionNode, treeEditMode: 'template' | 'division' = 'template'): DivisionNode => {
