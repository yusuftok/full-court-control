...
import { ProjectStatus, ProjectCategory, Project } from '@/components/projects/types/project-types'
...
export const mockProjectData: Record<string, DetailedProject> = MOCK_PROJECTS.reduce((acc, project) => {
