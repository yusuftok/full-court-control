...
describe('StatCard Component', () => {
  describe('Basic Rendering', () => {
    ...
    it('applies custom className', () => {
      render(
        <StatCard title="Users" value={100} className="custom-stat-card" />
      )
...
describe('StatCardGrid Component', () => {
  describe('Grid Layout', () => {
    ...
    it('applies 1-column grid classes', () => {
      render(
        <StatCardGrid columns={1} data-testid="grid">
          Content
        </StatCardGrid>
      )
    ...
    it('applies 2-column grid classes', () => {
      render(
        <StatCardGrid columns={2} data-testid="grid">
          Content
        </StatCardGrid>
      )
    ...
    it('applies 3-column grid classes', () => {
      render(
        <StatCardGrid columns={3} data-testid="grid">
          Content
        </StatCardGrid>
      )
    ...
    it('applies custom className along with base classes', () => {
      render(
        <StatCardGrid className="custom-grid" data-testid="grid">
          Content
        </StatCardGrid>
      )
...
describe('ProgressStatCard Component', () => {
  describe('Basic Rendering', () => {
    ...
    it('renders with unit suffix', () => {
      render(
        <ProgressStatCard title="Distance" current={25} target={50} unit="km" />
      )
  ...
  describe('Number Formatting', () => {
    it('formats large numbers with locale string', () => {
      render(
        <ProgressStatCard title="Big Numbers" current={1250} target={5000} />
      )
  ...
  describe('Layout and Styling', () => {
    ...
    it('has proper content structure with progress elements', () => {
      ...
      expect(screen.getByText('of 100')).toHaveClass(
        'text-sm',
        'text-muted-foreground'
      )
  ...
  describe('Edge Cases', () => {
    ...
    it('renders without description when not provided', () => {
      render(
        <ProgressStatCard title="Simple Progress" current={10} target={20} />
      )
