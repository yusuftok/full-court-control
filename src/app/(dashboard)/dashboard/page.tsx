...
export default function DashboardPage() {
  ...
  const criticalProjects = mockProjects.filter(p => p.progress < 30 && p.status === "active").length
  const onScheduleProjects = mockProjects.filter(p => p.progress >= 75 && p.status === "active").length
    ...
    <PageContainer>
      <PageContent>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-8 animate-stagger">
          ...
          <Card className="cursor-pointer floating-card group scale-smooth container-responsive border-l-4 border-l-amber-400 bg-gradient-to-br from-amber-50/50 to-transparent hover:shadow-amber-200/50 transition-all duration-300 relative overflow-hidden"
            onClick={() => alert(`🔴 Geciken İşler Detayı\n\n• Toplam Geciken: 8/250 iş (%3.2)\n• Kritik Path'te: 2 iş\n• Etkilenen Taşeron: 4 firma\n• Ortalama Gecikme: 3.5 gün\n\n⚠️ Normal seviyede gecikme oranı!`)}
          >
            ...
            <CardContent className="space-y-4">
              ...
              <div className="flex items-center gap-4">
                ...
                <div className="flex-1">
                  <div className="text-body-sm text-amber-600 mb-1">İş Durumu</div>
                  <div className="text-heading-sm text-amber-800 mb-2">3.2% Geciken</div>
          ...
          <Card className="cursor-pointer floating-card group scale-smooth container-responsive border-l-4 border-l-red-400 bg-gradient-to-br from-red-50/50 to-transparent hover:shadow-red-200/50 transition-all duration-300 relative overflow-hidden ring-2 ring-red-500/80"
            onClick={() => alert(`⏰ Kritik Deadline'lar\n\nBu Hafta (3): Pazartesi, Çarşamba, Cuma\nGelecek Hafta (5): Yoğun program\nBu Ay (12): Toplam milestone\n\n🚨 Hemen aksiyon gerekli!`)}
          >
            {/* Shimmer Effect for Urgent State */}
            <div className="absolute inset-0 -translate-x-full animate-shimmer opacity-70">
            ...
            <CardContent className="space-y-4">
              ...
              <div className="grid grid-cols-1 gap-3">
                <div className="group/item flex items-center gap-3 p-3 rounded-xl border border-red-200/50 bg-gradient-to-r from-red-50/50 to-transparent hover:from-red-100/70 transition-all duration-300"
                  onClick={(e) => {
                    e.stopPropagation()
                    alert(`⏰ Bu Hafta Kritik Deadline'lar\n\n• Pazartesi: Elektrik sistemi teslimi\n• Çarşamba: Yapı ruhsatı onayı\n• Cuma: Alt yüklenici ödemeleri\n\n🚨 Hemen aksiyon gerekli!`)
                  }}
                >
                  <div className="relative">
                    <CircularProgress 
                  ...
                  <div className="flex-1">
                    <div className="text-sm font-semibold text-red-800">Bu Hafta</div>
                ...
                <div className="grid grid-cols-2 gap-2">
                  <div className="p-2 rounded-lg border border-orange-200 bg-gradient-to-br from-orange-50 to-orange-100 text-center"
                    onClick={(e) => {
                      e.stopPropagation()
                  ...
                  <div className="p-2 rounded-lg border border-blue-200 bg-gradient-to-br from-blue-50 to-blue-100 text-center"
                    onClick={(e) => {
                      e.stopPropagation()
                      alert(`🗓️ Bu Ay Tamamlanacaklar\n\n• İç dekorasyon başlangıcı\n• Cam montaj işleri\n• Güvenlik sistemi kurulumu\n• Son kontrol ve testler`)
                    }}
                  >
          ...
          <Card className="cursor-pointer floating-card group scale-smooth container-responsive border-l-4 border-l-orange-400 bg-gradient-to-br from-orange-50/50 to-transparent hover:shadow-orange-200/50 transition-all duration-300 relative overflow-hidden ring-2 ring-orange-500/70"
            onClick={() => alert(`🏗️ Taşeron Risk Haritası\n\nSorunlu (2): Acil müdahale\nRiskli (3): Yakın takip\nBeklemede (4): Programlı\n\n⚠️ 9 taşerondan 5'i risk altında`)}
          >
            ...
            <CardContent className="space-y-4">
              ...
              <div className="space-y-3">
                <div className="flex items-center gap-3 p-2 rounded-lg border border-red-200 bg-gradient-to-r from-red-50 to-red-100/50"
                  onClick={(e) => {
                    e.stopPropagation()
                    alert(`🔴 Sorunlu Taşeronlar (2)\n\n• Elektrik A.Ş: İşleri 3 gün gecikmiş\n• Yapı Ltd: Kritik milestone kaçırıldı\n\n⚡ Acil müdahale gerekli`)
                  }}
                >
                  ...
                  <div className="flex-1">
                    <div className="text-sm font-semibold text-red-800">Sorunlu</div>
                    <div className="text-xs text-red-600">Acil müdahale</div>
                  </div>
                  <div className="size-2 bg-red-500 rounded-full animate-pulse" />
                </div>
                
                <div className="flex items-center gap-3 p-2 rounded-lg border border-yellow-200 bg-gradient-to-r from-yellow-50 to-yellow-100/50"
                  onClick={(e) => {
                    e.stopPropagation()
                    alert(`🟡 Riskli Taşeronlar (3)\n\n• Sıhhi Tesisat Co: Malzeme tedarik sorunu\n• Boyar İnşaat: İşçi kaynağı yetersiz\n• Demir Doğrama: Alt tedarikçi gecikmesi\n\n⚠️ Yakın takip öneriliyor`)
                  }}
                >
                  ...
                  <div className="flex-1">
                    <div className="text-sm font-semibold text-yellow-800">Riskli</div>
                    <div className="text-xs text-yellow-600">Yakın takip</div>
                  </div>
                </div>
                
                <div className="flex items-center gap-3 p-2 rounded-lg border border-blue-200 bg-gradient-to-r from-blue-50 to-blue-100/50"
                  onClick={(e) => {
                    e.stopPropagation()
                    alert(`⏸️ Beklemede Taşeronlar (4)\n\n• Cam Montaj: Elektrik tamamını bekliyor\n• Zemin Döşeme: Sıhhi tesisat onayı\n• Dış Cephe: Ruhsat onayı süreci\n• İç Dekorasyon: Zemin hazırlığı\n\n📋 Programlandı`)
                  }}
                >
                  ...
                  <div className="flex-1">
                    <div className="text-sm font-semibold text-blue-800">Beklemede</div>
              ...
              <div className="space-y-2">
                <div className="flex items-center justify-between text-xs">
                  ...
                  <span className="font-semibold text-orange-700">9 Taşeron</span>
                </div>
                <div className="h-2 bg-orange-100 rounded-full overflow-hidden flex">
                  <div className="bg-red-500 transition-all duration-700 ease-out" style={{ width: '22%' }} />
                  <div className="bg-yellow-500 transition-all duration-700 ease-out" style={{ width: '33%' }} />
                  <div className="bg-blue-500 transition-all duration-700 ease-out" style={{ width: '45%' }} />
                </div>
              </div>
          ...
          <Card className="cursor-pointer floating-card group scale-smooth container-responsive border-l-4 border-l-blue-400 bg-gradient-to-br from-blue-50/50 to-transparent hover:shadow-blue-200/50 transition-all duration-300"
            onClick={() => alert(`🎯 İş Akış Durumu\n\nGeciken (8): Odaklanma gerekli\nRisk Altında (15): Yakından izleniyor\nBloke (12): Bağımlılık beklemede\n\n📊 Toplam 35/250 iş takip gerektiriyor (%14 - Normal seviye)`)}
          >
            ...
            <CardContent className="space-y-4">
              ...
              <div className="relative">
                ...
                {/* Flow Status Grid */}
                <div className="grid grid-cols-3 gap-2 text-center">
                  <div className="p-2 rounded-lg border border-red-200 bg-gradient-to-br from-red-50 to-red-100 cursor-pointer hover:scale-105 transition-transform"
                    onClick={(e) => {
                      e.stopPropagation()
                      alert(`🔴 Geciken İşler (8)\n\n• Elektrik montajı (3 gün gecikti)\n• Sıhhi tesisat testleri (2 gün)\n• Yapı denetim raporu (4 gün)\n• Zemin hazırlığı (1 gün)\n\n🎯 Odaklanma gerekli`)
                    }}
                  >
                    <div className="text-lg font-bold text-red-700">8</div>
                    <div className="text-xs text-red-600">Geciken</div>
                  </div>
                  <div className="p-2 rounded-lg border border-yellow-200 bg-gradient-to-br from-yellow-50 to-yellow-100 cursor-pointer hover:scale-105 transition-transform"
                    onClick={(e) => {
                      e.stopPropagation()
                      alert(`🟡 Risk Altındaki İşler (15)\n\n• Dış cephe işleri (hava durumu)\n• Beton dökümü (malzeme gecikmesi)\n• Cam montajı (tedarikçi sorunu)\n• Boyama hazırlıkları\n\n👀 Yakından izleniyor`)
                    }}
                  >
                    <div className="text-lg font-bold text-yellow-700">15</div>
                    <div className="text-xs text-yellow-600">Risk</div>
                  </div>
                  <div className="p-2 rounded-lg border border-gray-200 bg-gradient-to-br from-gray-50 to-gray-100 cursor-pointer hover:scale-105 transition-transform"
                    onClick={(e) => {
                      e.stopPropagation()
                      alert(`⏸️ Bloke İşler (12)\n\n• İç dekorasyon (elektrik bekleniyor)\n• Zemin döşeme (sıhhi tesisat)\n• Boyama işleri (alçı kuruması)\n• Dış alan düzenleme\n\n🔗 Bağımlılık nedeniyle beklemede`)
                    }}
                  >
              ...
              <div className="flex items-center justify-between p-2 rounded-lg bg-gradient-to-r from-green-50 to-green-100 border border-green-200">
                <span className="text-sm font-semibold text-green-800">Normal Akış</span>
          ...
          <Card className="lg:col-span-2 floating-card glass-card border-l-4 border-l-blue-400 overflow-hidden">
            <CardHeader className="bg-gradient-to-r from-blue-50/50 to-transparent">
              <CardTitle className="flex items-center gap-3 text-heading-lg">
                ...
                <span className="font-bold tracking-tight">Canlı Faaliyet Akışı</span>
            ...
            <CardContent className="p-6">
              <div className="space-y-4 animate-stagger">
                ...
                <div className="group flex items-center gap-4 p-4 floating-card rounded-xl border border-red-200/50 border-l-4 border-l-red-400 bg-gradient-to-r from-red-50/30 to-transparent hover:from-red-50/60 transition-all duration-300 modern-hover relative overflow-hidden">
                  ...
                  <div className="flex-1">
                    <p className="font-bold text-red-800 text-body-md">Çatı izolasyonu 4 gün gecikecek</p>
                    <p className="text-body-sm text-muted-foreground">
                      <span className="font-medium text-blue-600">Şehir Merkezi Ofis Kompleksi</span> • <span className="font-medium text-orange-600">Bulut İzolasyon</span> • <span className="font-medium text-red-600">30 dk önce</span>
                    </p>
                  ...
                  <div className="flex flex-col items-end gap-1">
                    ...
                    <div className="text-xs text-muted-foreground">Hava koşulları</div>
                  </div>
                </div>
                ...
                <div className="group flex items-center gap-4 p-4 floating-card rounded-xl border border-yellow-200/50 border-l-4 border-l-yellow-400 bg-gradient-to-r from-yellow-50/30 to-transparent hover:from-yellow-50/60 transition-all duration-300 modern-hover">
                  ...
                  <div className="flex-1">
                    <p className="font-bold text-yellow-800 text-body-md">Taşeron işçi eksikliği bildirdi</p>
                    <p className="text-body-sm text-muted-foreground">
                      <span className="font-medium text-blue-600">Alışveriş Merkezi Genişletme</span> • <span className="font-medium text-orange-600">Demir Yapı</span> • <span className="font-medium">4 saat önce</span>
                    </p>
                  ...
                  <div className="flex flex-col items-end gap-1">
                    ...
                    <div className="text-xs text-muted-foreground">İşçi sorunu</div>
                  </div>
                </div>
                ...
                <div className="group flex items-center gap-4 p-4 floating-card rounded-xl border border-green-200/50 border-l-4 border-l-green-400 bg-gradient-to-r from-green-50/30 to-transparent hover:from-green-50/60 transition-all duration-300 modern-hover">
                  ...
                  <div className="flex-1">
                    <p className="font-bold text-green-800 text-body-md">Elektrik ana pano montajı tamamlandı</p>
                    <p className="text-body-sm text-muted-foreground">
                      <span className="font-medium text-blue-600">Konut Kulesi A</span> • <span className="font-medium text-orange-600">Aydın Elektrik</span> • <span className="font-medium">2 saat önce</span>
                    </p>
                ...
                <div className="group flex items-center gap-4 p-4 floating-card rounded-xl border border-blue-200/50 border-l-4 border-l-blue-400 bg-gradient-to-r from-blue-50/30 to-transparent hover:from-blue-50/60 transition-all duration-300 modern-hover">
                  ...
                  <div className="flex-1">
                    <p className="font-bold text-blue-800 text-body-md">Beton numune testi onaylandı</p>
                    <p className="text-body-sm text-muted-foreground">
                      <span className="font-medium text-blue-600">Hastane Ek Binası İnşaatı</span> • C30 dayanım sağlandı • <span className="font-medium">1 saat önce</span>
                    </p>
                  ...
                  <div className="flex flex-col items-end gap-1">
                    ...
                    <div className="text-xs text-muted-foreground">Kalite OK</div>
                  </div>
                </div>
                ...
                <div className="group flex items-center gap-4 p-4 floating-card rounded-xl border border-purple-200/50 border-l-4 border-l-purple-400 bg-gradient-to-r from-purple-50/30 to-transparent hover:from-purple-50/60 transition-all duration-300 modern-hover">
                  ...
                  <div className="flex-1">
                    <p className="font-bold text-purple-800 text-body-md">Yeni taşeron atandı</p>
                    <p className="text-body-sm text-muted-foreground">
                      <span className="font-medium text-blue-600">Otoyol Köprüsü Yenileme</span> • <span className="font-medium text-orange-600">Star Seramik</span> • <span className="font-medium">Az önce</span>
                    </p>
            ...
            <CardContent className="space-y-3 p-6">
              ...
              >
                ...
                <div className="relative flex items-center w-full">
                  ...
                  <div className="flex-1 text-left">
                    <div className="font-semibold text-orange-800 text-body-md">Onay İsteklerine Git</div>
                    <div className="text-caption text-orange-600 opacity-75">3 acil onay bekliyor</div>
                  </div>
              ...
              >
                ...
                <div className="relative flex items-center w-full">
                  ...
                  <div className="flex-1 text-left">
                    <div className="font-semibold text-purple-800 text-body-md">Yeni İş Maddesi Tanımla</div>
                    <div className="text-caption text-purple-600 opacity-75">Bir projeye yeni iş kalemi ekle</div>
                  </div>
              ...
              >
                ...
                <div className="relative flex items-center w-full">
                  ...
                  <div className="flex-1 text-left">
                    <div className="font-semibold text-blue-800 text-body-md">Yeni Proje Tanımla</div>
                    <div className="text-caption text-blue-600 opacity-75">Yeni inşaat projesi başlat</div>
                  </div>
              ...
              >
                ...
                <div className="relative flex items-center w-full">
                  ...
                  <div className="flex-1 text-left">
                    <div className="font-semibold text-green-800 text-body-md">Ekip Üyesi Al</div>
                    <div className="text-caption text-green-600 opacity-75">Personel & yetkinlik yönetimi</div>
                  </div>
        ...
        <div className="space-y-4">
          ...
          <div className="grid-responsive spacing-relaxed animate-stagger">
            {mockProjects.filter(p => p.status === "active").slice(0, 4).map((project, index) => (
              <ProjectCard
                key={project.id}
                project={project}
