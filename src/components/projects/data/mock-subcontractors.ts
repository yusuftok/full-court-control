...
export const mockSubcontractors: Subcontractor[] = [
  ...
  {
    id: 'sub-finishes-1',
    companyName: 'Nova Dekor İnce İşler',
    type: SubcontractorType.CONSTRUCTION,
    responsiblePerson: 'Serkan Akın',
    phone: '0543-321-7654',
    email: 'serkan@novadekor.com',
    address: 'Dekor Mah. Estetik Cad. No:21 Ataşehir/İstanbul',
    ...
    specializations: ['Sıva', 'Boya', 'Zemin Kaplama'],
  },
  {
